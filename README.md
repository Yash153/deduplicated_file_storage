...
A file storage system with deduplication and smart search capabilities.

## Features

- File upload with automatic deduplication
- Storage optimization by referencing duplicate files
...
```bash
git clone https://github.com/yourusername/abnormal-file-hub.git
...
### Backend Development
The backend runs in development mode with Django's development server.
